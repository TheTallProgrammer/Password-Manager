...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cipherText->setFont(font2);
        cipherText->setCursorPosition(0);
        cipherText->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label_2 = new QLabel(login);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(275, 210, 421, 41));
        ...
        createPassSubmitButton_2->setFont(font3);
        creationError_2 = new QLabel(createPass);
        creationError_2->setObjectName("creationError_2");
        creationError_2->setGeometry(QRect(90, 590, 801, 20));
        QPalette palette1;
        ...
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Bahnschrift SemiLight")});
        font5.setPointSize(13);
        cipherKeyText_2->setFont(font5);
        ...
        copyCipherButton_2->setFont(font3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_12->setText(QCoreApplication::translate("MainWindow", "Here\342\200\231s your generated cipher key. You\342\200\231ll need a key each time you open the app. You can use this one or your own, but always use the same key to avoid data issues. Don\342\200\231t save keys on your local machine.", nullptr));
