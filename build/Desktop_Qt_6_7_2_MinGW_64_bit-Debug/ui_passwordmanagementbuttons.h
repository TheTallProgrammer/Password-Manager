...
public:
    ...
    void setupUi(QDialog *passwordManagementButtons)
    {
        ...
        exportPassButton->setFont(font3);
        ...
        resetLoginButton->setFont(font4);
    ...
    void retranslateUi(QDialog *passwordManagementButtons)
    {
        ...
        exportPassButton->setText(QCoreApplication::translate("passwordManagementButtons", "Export/Import Passwords", nullptr));
